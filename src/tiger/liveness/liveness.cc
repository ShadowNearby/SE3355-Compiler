...
void LiveGraphFactory::LiveMap() {
  ...
  //      printf(
  //          "%s:\n",
  //          dynamic_cast<assem::OperInstr
  //          *>(node->NodeInfo())->assem_.c_str());
  //    }
  //    if (typeid(*node->NodeInfo()) == typeid(assem::MoveInstr)) {
  //      printf(
  //          "%s:\n",
  //          dynamic_cast<assem::MoveInstr
  //          *>(node->NodeInfo())->assem_.c_str());
  //    }
  //    if (typeid(*node->NodeInfo()) == typeid(assem::LabelInstr)) {
  //      printf(
  //          "%s:\n",
  //          dynamic_cast<assem::LabelInstr
  //          *>(node->NodeInfo())->assem_.c_str());
  //    }
  //    auto in = in_->Look(node);
  //    auto out = out_->Look(node);
  //    printf("in: ");
  //    for (auto inode : in->GetList()) {
  //      printf("%d ", inode->Int());
  //    }
  //    printf("\nout: ");
  //    for (auto inode : out->GetList()) {
  //      printf("%d ", inode->Int());
  //    }
  //    printf("\n");
  //  }
